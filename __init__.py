...
class SNA_GROUP_sna_dgs_scene_properties_group(bpy.types.PropertyGroup):
    ...
    r2_world_lighting: bpy.props.BoolProperty(name='World_Lighting', description='Use the World color or an Environment Texture connected through an optional Mapping node as low-frequency diffuse lighting; complex World node chains are not evaluated', default=False)
